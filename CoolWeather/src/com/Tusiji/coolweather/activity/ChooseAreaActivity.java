package com.Tusiji.coolweather.activity;
...
import com.Tusiji.coolweather.util.HttpCallbackListener;
import com.Tusiji.coolweather.util.HttpUtils;
import com.Tusiji.coolweather.util.Utility;
...
//		Toast.makeText(this, "dasd", Toast.LENGTH_SHORT).show();
	...
	*/
	...
	private void queryFromServer(final String code, final String type) {
		...
		showProgressDialog();
		HttpUtils.SendHttpRequset(address, new HttpCallbackListener() {
			@Override
